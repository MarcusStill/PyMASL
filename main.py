    ...
    def calculate_child_ticket(self, row: int) -> int:
        ...
        if duration == 1:
            ...
            if System.count_number_of_visitors['many_child'] == 1:
                ...
                price = System.what_a_day == 0 and System.price['ticket_child_2'] or System.price['ticket_child_week_2']
        else:
            if System.count_number_of_visitors['invalid'] == 1:
                price = System.price['ticket_free']
    ...
    def sale_transaction(self, payment_type, print_check) -> None:
        ...
        if System.sale_special == 1:
            ...
            if payment_type in (101, 100):
                ...
                payment = 2
                bank = None
            state_check = kkt.check_open(System.sale_dict, payment_type, System.user, 1, print_check,
                                         System.sale_dict['detail'][7], bank)
            # Если прошла оплата
            if state_check == 1:
