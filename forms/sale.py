...
################################################################################
## Form generated from reading UI file 'sale_7.ui'
##
...
class Ui_Dialog_Sale(object):
    def setupUi(self, Dialog_Sale):
        ...
        Dialog_Sale.resize(764, 791)
        self.groupBox = QGroupBox(Dialog_Sale)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(0, 0, 601, 341))
        ...
        self.tableWidget.setGeometry(QRect(0, 60, 771, 281))
        ...
        self.line.setGeometry(QRect(600, -10, 20, 801))
        self.line.setFrameShape(QFrame.VLine)
        self.line.setFrameShadow(QFrame.Sunken)
        self.line_2 = QFrame(Dialog_Sale)
        self.line_2.setObjectName(u"line_2")
        self.line_2.setGeometry(QRect(0, 400, 911, 20))
        ...
        self.tableWidget_2.setGeometry(QRect(0, 410, 601, 371))
        self.tableWidget_2.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.label_2 = QLabel(Dialog_Sale)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(650, 250, 51, 20))
        font = QFont()
        ...
        self.label_3.setGeometry(QRect(650, 420, 63, 21))
        ...
        self.pushButton_4.setGeometry(QRect(640, 740, 95, 45))
        font1 = QFont()
        font1.setPointSize(11)
        self.pushButton_4.setFont(font1)
        self.label_4 = QLabel(Dialog_Sale)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(620, 280, 71, 31))
        font2 = QFont()
        font2.setPointSize(10)
        self.label_4.setFont(font2)
        self.label_5 = QLabel(Dialog_Sale)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(710, 290, 21, 20))
        self.label_5.setFont(font2)
        self.label_6 = QLabel(Dialog_Sale)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(620, 320, 61, 51))
        self.label_6.setFont(font2)
        self.label_7 = QLabel(Dialog_Sale)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setGeometry(QRect(710, 340, 21, 20))
        self.label_7.setFont(font2)
        self.label_8 = QLabel(Dialog_Sale)
        self.label_8.setObjectName(u"label_8")
        self.label_8.setGeometry(QRect(720, 380, 41, 20))
        self.label_8.setFont(font)
        self.label_9 = QLabel(Dialog_Sale)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setGeometry(QRect(620, 380, 121, 20))
        self.label_9.setFont(font)
        self.pushButton_5 = QPushButton(Dialog_Sale)
        self.pushButton_5.setObjectName(u"pushButton_5")
        self.pushButton_5.setGeometry(QRect(640, 550, 95, 45))
        self.pushButton_5.setFont(font1)
        self.pushButton_6 = QPushButton(Dialog_Sale)
        self.pushButton_6.setObjectName(u"pushButton_6")
        self.pushButton_6.setGeometry(QRect(640, 660, 95, 45))
        self.pushButton_6.setFont(font1)
        self.pushButton_7 = QPushButton(Dialog_Sale)
        self.pushButton_7.setObjectName(u"pushButton_7")
        self.pushButton_7.setGeometry(QRect(640, 70, 95, 45))
        self.pushButton_7.setFont(font1)
        self.label_10 = QLabel(Dialog_Sale)
        self.label_10.setObjectName(u"label_10")
        self.label_10.setGeometry(QRect(650, 20, 63, 20))
        self.label_10.setFont(font)
        self.pushButton_8 = QPushButton(Dialog_Sale)
        self.pushButton_8.setObjectName(u"pushButton_8")
        self.pushButton_8.setGeometry(QRect(640, 140, 95, 45))
        ...
        self.label_14.setGeometry(QRect(620, 480, 81, 20))
        font3 = QFont()
        font3.setPointSize(9)
        self.label_14.setFont(font3)
        self.line_4 = QFrame(Dialog_Sale)
        self.line_4.setObjectName(u"line_4")
        self.line_4.setGeometry(QRect(610, 600, 181, 21))
        self.line_4.setFrameShape(QFrame.HLine)
        self.line_4.setFrameShadow(QFrame.Sunken)
        self.checkBox_2 = QCheckBox(Dialog_Sale)
        self.checkBox_2.setObjectName(u"checkBox_2")
        self.checkBox_2.setEnabled(True)
        self.checkBox_2.setGeometry(QRect(620, 450, 95, 25))
        ...
        self.comboBox_2.setGeometry(QRect(620, 500, 78, 30))
        self.line_5 = QFrame(Dialog_Sale)
        self.line_5.setObjectName(u"line_5")
        self.line_5.setGeometry(QRect(610, 220, 201, 21))
        ...
        self.line_6.setGeometry(QRect(610, 710, 181, 21))
        self.line_6.setFrameShape(QFrame.HLine)
        self.line_6.setFrameShadow(QFrame.Sunken)
        self.label_16 = QLabel(Dialog_Sale)
        self.label_16.setObjectName(u"label_16")
        self.label_16.setGeometry(QRect(650, 620, 63, 21))
